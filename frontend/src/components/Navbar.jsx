...
function Navbar() {
  ...
  return (
    ...
    <nav className="bg-white shadow-xl text-black sticky top-0 z-50 backdrop-blur-sm">
      ...
      <div className="w-full max-w-[1100px] mx-auto px-4 py-0 flex justify-between items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="hidden lg:flex items-center gap-2 font-bold  bg-yellow-400 hover:bg-gray-200 px-3 py-1 rounded-full transition-colors text-sm">
            <FaBars />
            Categorías
          </button>
        </div>
        ...
        <div className="hidden md:flex flex-1 max-w-xl relative">
          <input 
            ...
            className="w-full border border-gray-500 rounded-full py-2 pl-4 pr-10 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm"
          />
        ...
        <ul className="flex gap-4 text-lg font-semibold items-center">
          ...
          <li>
            <Link to="/cart" className="hover:text-blue-500 transition-colors">
              <FiShoppingCart className="inline text-2xl" />
            </Link>
          </li>
